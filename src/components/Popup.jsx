...
function Popup() {
  return (
    <div>
      <section className="section career-section register register-popup">
  <div className="twocol-row">
    <div className="col-75 bg-grey-color">
      <div className="about-us-right-img">
        <div
          className="about-us-head animate"
        ...
        <form action="../mail/mailv1.php" id="popup-form" method="POST">
          <div className="twocol-row">
            ...
            <div className="col-50">
              ...
              {/* <div class="form-group">
                              <label for="first-name" class="animate" data-animation="fadeInUp"
                                  data-duration="1100">Phone Number*</label>
                              <div class="country-input">
                                  <select name="country_code" id="country_code" class="animate" data-animation="fadeInUp"
                                      data-duration="1200">
                                  ...
                                  <input type="text" class="animate" data-animation="fadeInUp"
  ...
  <div className="register-popup__cross-btn">
    <img src="/assets/svg/rounded-cross.svg" alt="icon" />
  </div>
</section>
