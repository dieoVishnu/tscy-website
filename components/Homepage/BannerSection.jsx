  ...
  return (
    <div className="section banner-section">
      ...
      >
        <SwiperSlide>
          <div className="hero-slide-wrapper">
            <div className="hero__img">
              <img src="/assets/images/banner-img/banner-img-1.png" alt="banner-img" />
            </div>
        ...
        <SwiperSlide>
          <div className="hero__img">
            <img src="/assets/images/banner-img/banner-img-2.png" alt="banner-img" />
          </div>
          <div className="hero__caption">
            <h1>
              LEAD THE CHANGE
        ...
        <SwiperSlide>
          <div className="hero__img">
            <img src="/assets/images/banner-img/banner-img-3.png" alt="banner-img" />
          </div>
          <div className="hero__caption">
            <h1>
              LEAD THE CHANGE
