...
//     $('#innerFullpage').find('header').addClass('fp-auto-height fp-section fp-table');
...
//         autoScrolling: true,
//         navigation: true,
//         navigationTooltips: ['The Sustainable City Yiti', 'Sustainable Features', 'Master Plan', 'Newsroom', 'Location', ],
//         anchors: ['TheSustainableCityYiti', 'SustainableFeatures', 'MasterPlan', 'Newsroom', 'Location'],
...
//         $(this).addClass('active').siblings().removeClass("active").parent().siblings(".img__wrapper").addClass("active");
...
//         $(".default-img").removeClass("d-none").siblings().addClass("d-none").parent().removeClass("active");
...
//        let valueSelectedd =  $('.master-plan-card__title-wrapper--fields form select').val();
//         $('#villas-submit').attr('href',valueSelectedd);
//     }
//     villaSelect();

//     $('.master-plan-card__title-wrapper--fields form select').on('change', function (e) {
